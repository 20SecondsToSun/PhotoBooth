...
class ToyotaPhotoBooth : public AppNative {
  public:
...
void ToyotaPhotoBooth::update()
{
	game.Update();
	AssetManager::getInstance()->update();
}

void ToyotaPhotoBooth::draw()
{
...
void ToyotaPhotoBooth::shutdown()
{
	CameraAdapter::Instance()->shutdown();
}

void ToyotaPhotoBooth::keyDown( KeyEvent event )
{
...
CINDER_APP_NATIVE( ToyotaPhotoBooth, RendererGl )